...
//            CGFloat x = (clampedOffset * 0.5f * tilt + offset * spacing + clampedOffset*spacing*1.0) * _itemWidth;
            ...
            {
//                CGFloat absOffset = fabs(clampedOffset);
//                CGFloat scale = 1.0+0.40*(1-absOffset);
...
//        [_contentView addSubview:[self containView:view]];
        [_contentView insertSubview:[self containView:view] atIndex:0];
    }
    [self transformItemView:view atIndex:index];
